...
public class Stemmer implements Serializable{
     ...
     * @return
     */
    private boolean is_vowel(char cc) {
        String c = ""+cc;
        return ("o".equals(c) || "u".equals(c) || "á".equals(c) || "a".equals(c) || "e".equals(c) || "i".equals(c) || "é".equals(c) || "í".equals(c) || "ó".equals(c) || "ú".equals(c));
    }
    ...
    public String stemm(String word) {
        ...
        if (word_after0.equals(word_after1)) {
            ...
            if (word_after2a.equals(word_after1)) {
                if (!(suf = endsinArr(rv_txt, array("en", "es", "éis", "emos"))).equals("")) {
                    word = substr(word, 0, -strlen(suf));
                    if (endsin(word, "gu")) {
